  ...
  return (
    <>
      ...
      <div className="kpi-grid">
        ...
        <KPICard label="Due Now" value={fmtEGP(totalDueEGP)} sub={`${upcoming.length} payments`} />
      </div>
              ...
              <div key={p.id} className="project-card" onClick={() => navigate(`/projects/${p.id}`)}>
                <div className="project-card-header">
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.75rem', color: '#64748b' }}>{p.developer} &middot; {p.type}</div>
                  </div>
                  {p.shared ? <span className="pill pill-shared" style={{ marginLeft: 'auto' }}>Shared</span> : null}
                </div>
                ...
                <div className="project-card-stats">
                  ...
                  <div>
                    ...
                    <div className="project-stat-value">{fmtEGP(p.payments?.paid_egp || 0)}</div>
                  </div>
                </div>
      ...
      {upcoming.length > 0 && (
        <div className="section">
          <h2 className="section-title">Due & Overdue Payments</h2>
          <div className="card">
